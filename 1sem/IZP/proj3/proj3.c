...
void init_cluster(struct cluster_t *c, int cap)
{
    ...
    // TODO
	c->obj = malloc(cap * sizeof(c->obj)); //////FUCK
	c->capacity = cap;
	c->size = 0;
...
{
    // TODO
	// ak je kapacita = poctu objektov, zvacsit ju
	// pridat na size + 1
	
	if((c->capacity) == (c->size)) //zvacsi kapacitu clusteru o 1, ak je kapacita plna
	{
...
int load_clusters(char *filename, struct cluster_t **arr)
{
    ...
    // TODO
	FILE *fr;
	char scount[20]; //pre ulozenie count z *fr
	
	fr = fopen(filename, "r");
	
	fgets(scount, 20, fr);
	
	int count = atoi(&scount[6]);
	
	struct cluster_t *array;
	array = malloc(count * sizeof(struct cluster_t));
